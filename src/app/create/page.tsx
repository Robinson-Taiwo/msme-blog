  ...
  export default function EditorPage() {
    ...
    return (
      <div className="min-h-screen bg-white flex flex-col">
            ...
            <div className="space-y-8">
              ...
              <div className="w-full flex-col border-[0.5px] border-[#0000001A] border-opacity-10 flex">
                ...
                <div className="flex justify-end px-6 py-4">
                  <Button className="bg-gray-900 text-white hover:bg-gray-800">Publish</Button>
                </div>
              </div>
            </div>
          </div>
        ...
        <PostSettingsSheet open={isSettingsOpen} onOpenChange={setIsSettingsOpen} post={postData} onDelete={handleDelete} delete={isDelete} />
      </div>
    );
  }
